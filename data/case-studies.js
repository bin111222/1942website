export const caseStudies = [
  {
    ...
    slug: 'sculptique-website',
    thumbnail: '/case-studies/sculptique.svg',
    heroImage: '/case-studies/placeholder-hero.svg',
    description: 'AI-driven website with custom chatbot integration and advanced analytics',
    category: 'Web Development',
    tags: ['AI Integration', 'Web Design', 'Chatbot', 'Analytics'],
  ...
  },
  {
    ...
    slug: 'hks-clinic',
    thumbnail: '/case-studies/hks.svg',
    heroImage: '/case-studies/placeholder-hero.svg',
    description: 'Complete digital transformation and brand identity overhaul',
    category: 'Branding & Web',
    tags: ['Branding', 'Web Design', 'SEO', 'Digital Marketing'],
